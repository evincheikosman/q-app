...
- Slow burn / feel-good vibe: Start HANDS-AND-KNEES (e.g. Wheelbarrow or Spoon) → FOREARMS-AND-KNEES (Saw or Forearm Plank) → HANDS-AND-KNEES (Super Crunch or Spoon) → HANDS-AND-TOES (Bear or Plank to Pike)
...
- Steady / sustained energy vibe: Start FOREARMS-AND-KNEES (Forearm Plank or Saw) → HANDS-AND-KNEES (Wheelbarrow or Reverse Wheelbarrow) → HANDS-AND-TOES (Plank to Pike) → HANDS-AND-KNEES (Bungee Crunch or Spoon)
- Core/oblique focus: Prioritize HANDS-AND-KNEES moves (Wheelbarrow, Super Crunch, Reverse Super Crunch, Spoon) — these demand more rotational and deep core stability than HANDS-AND-TOES moves.

CORE OPENER TRANSITION RULE: Catfish [STANDING-FRONT-T-BAR] and Reverse Catfish [STANDING-BACK-T-BAR] must NEVER appear in the same core opener — they are at opposite ends of the machine. Similarly, never sequence any STANDING-FRONT-T-BAR move adjacent to any STANDING-BACK-T-BAR move within the opener.
...
- Core/oblique focus: Choose core opener moves that demand deep core stability (Super Crunch, Wheelbarrow, Spoon over simple Plank). Choose 3 distinct oblique moves per block — no two from the same position group. End with a crunch-based core closer.
...
HANDS-AND-TOES (front platform): Plank, Bear, Plank to Pike, Giant Plank to Pike, Reverse Twisted Bear (Single Side Bear), Twisted Plank to Pike, Dancing Bear
FOREARMS-AND-KNEES (carriage, facing front): Saw, Forearm Plank, Floor Strap Crunch, S-Strap Crunch, Twisted Saw
HANDS-AND-KNEES (carriage, facing front): Wheelbarrow, Spoon, Super Crunch, Reverse Super Crunch, Bungee Crunch, Twisted Wheelbarrow, Reverse Wheelbarrow
STANDING-FRONT-T-BAR (standing at front of machine, hands gripping front T-bar, toes on carriage, facing front mirror — transitions naturally from FOREARMS-AND-KNEES and HANDS-AND-TOES front platform moves): Catfish, Giant Catfish, Twisted Catfish
STANDING-BACK-T-BAR (standing at back of machine, hands gripping back T-bar, toes on carriage, facing back wall — transitions naturally from STANDING-BACK-PLATFORM moves. REQUIRES walking to other end of machine from any front-of-machine position — do NOT sequence adjacent to any STANDING-FRONT-T-BAR move): Reverse Catfish, Giant Reverse Catfish
KNEELING-FACING-BACK (back platform, facing back): Giant Wheelbarrow, Giant Kneeling Crunch, Giant Reverse Kneeling Crunch, Mega Catfish, Icebreaker, Kneeling Side Crunch, Kneeling Bicep Curl
GIANT-REVERSE-SERIES (back platform, facing back — zero repositioning between these): Giant Reverse Wheelbarrow, Giant Reverse Bear, Giant Reverse Kneeling Crunch, Giant Reverse Plank to Pike, Giant Reverse Saw — preferred for core closer
...
STANDING-FRONT-PLATFORM: Elevator Lunge, Elevator Split Lunge, Floor Lunge, Reverse Floor Lunge, Well Lunge, Back Lunge, Single Leg Squat, Fifth Lunge, Fifth Split Lunge, Escalator Lunge, Escalator Split Lunge, Spider Lunge, Runner's Lunge, Reverse Runner's Lunge, Ninja Kick (standing sideways, working knee drives toward chest then extends), Spider Kick (standing at front, leg drives back and up), Inner Thighs, Outer Thighs, Heavy Squats, Light Squats, Hamstring Curls, Bungee Kick, Heavy Leg Press C-Bar, Side Kick (client stands sideways on machine at front platform, non-working toes on carriage, working leg extends laterally — unilateral glute/abductor move)
STANDING-BACK-PLATFORM: Deadlift, Single Leg Deadlift, Mega Donkey Kick, Giant Single Leg Squat, Express Lunge (working leg on back platform facing back, non-working foot steps onto carriage behind the carriage strap), Express Split Lunge
...
SUPINE-ON-CARRIAGE (lying on back, hands gripping C-bar at front of machine, feet toward back): Shoulder Press — client lies on carriage, presses carriage away using shoulder/chest. Cannot be sequenced adjacent to kneeling or prone moves without full repositioning.
PRONE-ON-CARRIAGE (lying on stomach, facing down): Swimmer — client lies prone, alternating arm drives forward and back. Cannot be sequenced adjacent to kneeling or supine moves without full repositioning.
...
HAMSTRING CURLS BILATERAL RULE: Hamstring Curls is a bilateral move and may only appear ONCE per routine — at the very start of the right leg block. Do NOT mirror it on the left leg block. However, Hamstring Curls should NOT appear in every routine. Only use it when the instructor's selected emphasis is glutes/hamstrings OR when the energy arc is slow burn or sustained. For peak-and-hold, dark/driven, or core-focused routines, skip the bilateral opener and begin the right leg block directly with the first unilateral move. Vary what opens the leg block.

DO NOT sequence a move and its Reverse variant back-to-back anywhere in the routine. This applies to: Catfish/Reverse Catfish, Super Crunch/Reverse Super Crunch, Bear/Reverse Bear, Wheelbarrow/Reverse Wheelbarrow, Plank to Pike/Reverse Plank to Pike, Saw/Reverse Saw. These are opposite-facing or opposite-direction variants that require a full repositioning to transition between them.
...
- Slow burn / feel-good: HANDS-AND-TOES series (Plank → Plank to Pike → Bear) or HANDS-AND-KNEES series (Wheelbarrow → Super Crunch → Bungee Crunch). Familiar positions, high intention.
...
CORE CLOSER POSITION RULE: All moves in the core closer must come from the same position group or adjacent groups with minimal repositioning. Preferred closer sequences:
- Back platform series: Giant Wheelbarrow [KNEELING-FACING-BACK] → Giant Kneeling Crunch [KNEELING-FACING-BACK] → Giant Super Crunch (sit where knees are, toes under carriage strap) — zero repositioning
- Giant Reverse series: Giant Reverse Kneeling Crunch → Giant Reverse Plank to Pike → Giant Reverse Bear — zero repositioning
- Front platform series: Wheelbarrow → Catfish → Plank to Pike — minimal repositioning
Never mix front-platform and back-platform moves in the same closer.

MOVE DATABASE:
CORE (1 yellow spring, 1 min each):
Plank [HANDS-AND-TOES], Forearm Plank [FOREARMS-AND-KNEES], Wheelbarrow [HANDS-AND-KNEES], Reverse Wheelbarrow [HANDS-AND-KNEES], Giant Wheelbarrow [KNEELING-FACING-BACK], Giant Reverse Wheelbarrow [GIANT-REVERSE-SERIES], Saw [FOREARMS-AND-KNEES], Reverse Saw [FOREARMS-AND-KNEES facing back], Bear [HANDS-AND-TOES], Reverse Bear [HANDS-AND-TOES], Giant Bear [HANDS-AND-TOES back platform], Giant Reverse Bear [GIANT-REVERSE-SERIES], Plank to Pike [HANDS-AND-TOES], Reverse Plank to Pike [HANDS-AND-TOES], Giant Plank to Pike [HANDS-AND-TOES back platform], Giant Reverse Plank to Pike [GIANT-REVERSE-SERIES], Catfish [STANDING-FRONT-T-BAR], Reverse Catfish [STANDING-BACK-T-BAR], Giant Catfish [STANDING-FRONT-T-BAR], Giant Reverse Catfish [STANDING-BACK-T-BAR], Spoon [HANDS-AND-KNEES], Giant Spoon [KNEELING-FACING-BACK], Super Crunch [HANDS-AND-KNEES], Reverse Super Crunch [HANDS-AND-KNEES], Giant Kneeling Crunch [KNEELING-FACING-BACK], Giant Reverse Kneeling Crunch [GIANT-REVERSE-SERIES], Floor Strap Crunch [FOREARMS-AND-KNEES], S-Strap Crunch [FOREARMS-AND-KNEES], Bungee Crunch [HANDS-AND-KNEES], Cobra [HANDS-AND-TOES — opener or middle only, never last move]

LIGHT LEGS (1 yellow, 2 min unless noted):
Elevator Lunge [STANDING-FRONT-PLATFORM], Elevator Split Lunge [STANDING-FRONT-PLATFORM], Floor Lunge [STANDING-FRONT-PLATFORM], Reverse Floor Lunge [STANDING-FRONT-PLATFORM], Express Lunge [STANDING-BACK-PLATFORM], Express Split Lunge [STANDING-BACK-PLATFORM], Back Lunge [STANDING-FRONT-PLATFORM], Single Leg Squat [STANDING-FRONT-PLATFORM], Well Lunge [STANDING-FRONT-PLATFORM], Escalator Lunge [STANDING-FRONT-PLATFORM], Escalator Split Lunge [STANDING-FRONT-PLATFORM], Fifth Lunge [STANDING-FRONT-PLATFORM], Fifth Split Lunge [STANDING-FRONT-PLATFORM], Hamstring Curls 1 min [STANDING-FRONT-PLATFORM], Inner Thighs 1 min [STANDING-FRONT-PLATFORM], Light Squats 1 min [STANDING-FRONT-PLATFORM], Giant Single Leg Squat 2 min [STANDING-BACK-PLATFORM]
...
Twisted Wheelbarrow [HANDS-AND-KNEES], Twisted Saw [FOREARMS-AND-KNEES], Twisted Plank to Pike [HANDS-AND-TOES], Reverse Twisted Bear (Single Side Bear) [HANDS-AND-TOES], Kneeling Side Crunch [KNEELING-FACING-BACK], Soul Train [BACK-OF-MACHINE-OBLIQUES], Reverse Soul Train [BACK-OF-MACHINE-OBLIQUES], Mermaid [KNEELING-ON-CARRIAGE-FACING-FRONT], Mermaid Twist [KNEELING-ON-CARRIAGE-FACING-FRONT], Floor Strap Bicycle Crunch [LYING-ON-CARRIAGE], Side Plank [LYING-ON-CARRIAGE], French Twist [SITTING-FACING-FRONT], Teaser [SITTING-FACING-FRONT], Twisted Catfish [STANDING-FRONT-T-BAR], Scrambled Eggs [SITTING-FACING-FRONT], Torso Twist [SITTING-FACING-FRONT], Dancing Bear [HANDS-AND-TOES]

LIGHT ARMS (3-5 yellow, 1 min each):
Serve the Platter [KNEELING-ON-CARRIAGE-FACING-FRONT], Hug a Tree [KNEELING-ON-CARRIAGE-FACING-FRONT], Shoulder Press [SUPINE-ON-CARRIAGE], Tricep Extension [KNEELING-ON-CARRIAGE-FACING-FRONT], Shoulder Raise [KNEELING-ON-CARRIAGE-FACING-FRONT], Chest Opener [KNEELING-ON-CARRIAGE-FACING-BACK], Sexy Back [KNEELING-ON-CARRIAGE-FACING-BACK], Newspaper [KNEELING-ON-CARRIAGE-FACING-FRONT], Kneeling Bicep Curl [KNEELING-FACING-BACK], Reverse Fly [KNEELING-ON-CARRIAGE-FACING-BACK], Single Arm Tricep Kickback [KNEELING-ON-CARRIAGE-FACING-FRONT], Kneeling Lat Pulldown [BACK-PLATFORM-CABLES-OVERHEAD]

HEAVY ARMS (1 red + 1-2 yellow, 1 min each):
Mega Chest Fly [KNEELING-ON-CARRIAGE-FACING-FRONT], Mega Chest Press [KNEELING-ON-CARRIAGE-FACING-FRONT], Tailbone Bicep Curl [SITTING-FACING-FRONT], Mega Shoulder Press [KNEELING-ON-CARRIAGE-FACING-FRONT], Swimmer [PRONE-ON-CARRIAGE], Heavy Sexy Back [KNEELING-ON-CARRIAGE-FACING-BACK], Wide Mega Row [SITTING-FACING-FRONT], Narrow Seated Row [SITTING-FACING-FRONT], Mega Preacher Curl [BACK-PLATFORM-CABLES-OVERHEAD], Mega Lat Pull [BACK-PLATFORM-CABLES-OVERHEAD]
