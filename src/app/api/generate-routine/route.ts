...
Serve the Platter [KNEELING-ON-CARRIAGE-FACING-FRONT], Hug a Tree [KNEELING-ON-CARRIAGE-FACING-FRONT], Shoulder Press [KNEELING-ON-CARRIAGE-FACING-FRONT], Tricep Extension [KNEELING-ON-CARRIAGE-FACING-FRONT], Shoulder Raise [KNEELING-ON-CARRIAGE-FACING-FRONT], Chest Opener [KNEELING-ON-CARRIAGE-FACING-BACK], Sexy Back [KNEELING-ON-CARRIAGE-FACING-BACK], Newspaper [KNEELING-ON-CARRIAGE-FACING-FRONT], Kneeling Bicep Curl [KNEELING-FACING-BACK], Reverse Fly [KNEELING-ON-CARRIAGE-FACING-BACK], Single Arm Tricep Kickback [KNEELING-ON-CARRIAGE-FACING-FRONT], Kneeling Lat Pulldown [BACK-PLATFORM-CABLES-OVERHEAD]
